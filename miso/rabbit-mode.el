(defun rabbit-mode ()
  ...
  (local-set-key (kbd "s-<up>")  'rabbit-previous)
  (local-set-key (kbd "s-<down>")  'rabbit-forward)
  )

(defun global-rabbit-mode ()
  (interactive)
  (global-set-key (kbd "s-<up>")  'rabbit-previous)
  (global-set-key (kbd "s-<down>")  'rabbit-forward)
